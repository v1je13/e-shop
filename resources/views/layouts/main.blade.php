        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <form class="flex items-center">
                    ...
                    <button type="submit" class="ml-2 px-3 py-1.5 bg-gray-800 text-white rounded-lg text-sm hover:bg-gray-700 dark:bg-yellow-500">Найти</button>
                </form>
                ...
                <button id="theme-toggle" type="button" class="text-sm font-medium
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="md:text-right">
                    <p class="text-sm text-gray-500 dark:text-yellow-700">
